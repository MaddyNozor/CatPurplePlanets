...
/*   Updated: 2025/10/06 15:02:56 by mairivie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) {
    ...
    std::cout << PURPLE "\nB0SS-Trap tries to repair again... WARNING: It's beyond its full life!" RESET << std::endl;
    boss.beRepaired(40);
    boss.status();
    
    std::cout << RED "\nRED ALERT ! OVERLOAD ! The factory is collapsing! Robots must shut down..." RESET << std::endl;
