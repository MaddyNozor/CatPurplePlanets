...
/*   Updated: 2025/10/07 12:36:49 by mairivie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::setHitPoint(const int newValue) {
    ...
    newValue > MAX_HP_CT ? _hitPoint = MAX_HP_CT : _hitPoint = newValue;
}
...
void ClapTrap::setManaPoint(const int newValue) {
    ...
    newValue > MAX_MANA_CT ? _manaPoint = MAX_MANA_CT : _manaPoint = newValue;
}
